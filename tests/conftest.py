...
def file_different_dates():
    return [
        {
            "Дата операции": "31.12.2023 23:59:59",
...
def nested_data():
    return {
        ...
        "info": {
            ...
            "items": [{"time": datetime(2023, 1, 5, 12, 0, 0)}],
        },
    }
...
def sample_transactions_top_transactions():
    return [
        ...
        {
            "Сумма операции": -200,
            "Дата платежа": datetime(2023, 5, 20),
        ...
        {
            "Сумма операции": 300,
            "Дата платежа": datetime(2023, 5, 25),
            "Категория": "Возврат",
...
def sample_transaction_data():
    return DataFrame(
        {
            "Дата операции": ["2023-05-01", "2023-05-15", "2023-05-31", "2023-04-30", "2023-06-01"],
...
@pytest.fixture
def sample_transaction_data_cashback():
    """Фикстура с тестовыми данными транзакций"""
    data = [
        {"Дата операции": datetime(2023, 5, 1), "Описание": "Транзакция 1"},
        {"Дата операции": datetime(2023, 5, 15), "Описание": "Транзакция 2"},
        {"Дата операции": datetime(2023, 5, 31), "Описание": "Транзакция 3"},
        {"Дата операции": datetime(2023, 4, 30), "Описание": "Транзакция 4"},
        {"Дата операции": datetime(2023, 6, 1), "Описание": "Транзакция 5"},
        {"Дата операции": datetime(2022, 5, 15), "Описание": "Транзакция 6"},
    ]
    return pd.DataFrame(data)


@pytest.fixture
def sample_transactions_cashback_info():
    """Фикстура с тестовыми транзакциями"""
    data = [
        {"Дата операции": datetime(2023, 5, 1), "Категория": "Продукты", "Бонусы (включая кэшбэк)": 50},
        {"Дата операции": datetime(2023, 5, 15), "Категория": "Транспорт", "Бонусы (включая кэшбэк)": 30},
        {"Дата операции": datetime(2023, 5, 31), "Категория": "Продукты", "Бонусы (включая кэшбэк)": 20},
        {"Дата операции": datetime(2023, 5, 10), "Категория": "Наличные", "Бонусы (включая кэшбэк)": 100},
        {"Дата операции": datetime(2023, 5, 20), "Категория": "Переводы", "Бонусы (включая кэшбэк)": 40},
        {"Дата операции": datetime(2023, 4, 30), "Категория": "Продукты", "Бонусы (включая кэшбэк)": 70},
    ]
    return pd.DataFrame(data)


@pytest.fixture
def sample_transactions_reports():
    """Фикстура с тестовыми транзакциями"""
    data = [
        {
            "Дата операции": datetime(2023, 12, 1, 0, 0, 0),
            "Категория": "Продукты",
        },
        {
            "Дата операции": datetime(2023, 11, 15, 1, 1, 1),
            "Категория": "Транспорт",
        },
        {
            "Дата операции": datetime(2023, 10, 31, 2, 2, 2),
            "Категория": "Продукты",
        },
        {
            "Дата операции": datetime(2023, 10, 10, 3, 3, 3),
            "Категория": "Транспорт",
        },
        {
            "Дата операции": datetime(2023, 9, 20, 4, 4, 4),
            "Категория": "Продукты",
        },
        {
            "Дата операции": datetime(2023, 9, 11, 5, 5, 5),
            "Категория": "Продукты",
        },
    ]
    return pd.DataFrame(data)
