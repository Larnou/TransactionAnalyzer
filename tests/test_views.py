...
def test_main_view_basic_structure(
    ...
    mock_currency.return_value = [{"currency": "USD", "rate": 75.5}, {"currency": "EUR", "rate": 89.2}]
    mock_stock.return_value = [{"stock": "AAPL", "price": 150.25}, {"stock": "GOOGL", "price": 2800.75}]
...
def test_main_event_basic_structure(
    ...
    mock_expenses_top.return_value = [{"category": "Еда", "amount": 5000}, {"category": "Транспорт", "amount": 4000}]
    mock_transfers.return_value = [{"category": "Переводы", "amount": 3000}, {"category": "Наличные", "amount": 2000}]
